...
export default function ContactForm() {
  ...
  return (
    <div className="relative lg:p-10 p-3 lg:m-10 m-5 lg:rounded-[100px] rounded-lg bg-gradient-to-b from-blue-600 via-purple-600 to-fuchsia-600 bg-cover bg-center flex flex-col lg:flex-row items-center justify-center text-white">
